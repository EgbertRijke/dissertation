\chapter{$2$-simplicial types}\label{chap:simplicial}
...
\tilde A_0 & \tilde A_0 \arrow[from=ul,crossing over] & \tilde A_0. 
\end{tikzcd}
\end{equation*}
...
Given a coherent $H$-space $X$, the geometric realization of the $2$-simplicial type $S^2 X$ is the cofiber of the Hopf fibration $X \hookrightarrow \join{X}{X} \twoheadrightarrow \susp X$.
\end{cor}
