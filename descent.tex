...
We now state the flattening lemma for pushouts, which should be compared to Lemma 6.12.2 of \cite{hottbook}.
...
Since $\mathsf{cart\usc{}map}_{\mathcal{S}}$ is an equivalence it follows that its fibers are contractible. We will first specify the data of a commuting cube.
