...
In this chapter we study reflexive graphs, i.e.~types equipped with a type-valued reflexive relation, and their reflexive coequalizers. 

First we show that the universe embeds into the universe of small reflexive graphs. Reflexive graphs in the image of this embedding are called discrete. The reflexive coequalizer is an operation that reflects reflexive graphs back into the universe of types. We show that the reflexive coequalizer of a reflexive graph can be obtained as a pushout.
