...
We will see in \cref{thm:etale_fibration}\marginnote{This theorem is in a much later chapter!} that a morphism of reflexive graphs is a fibration if and only if the square
\begin{equation*}
\begin{tikzcd}
...
\end{tikzcd}
\end{equation*}
of types is a pullback square.\marginnote{Write up proof}
\end{enumerate}
\end{thm}
